...
\usepackage[
    pdftitle={Arif Rahman Resume},
    pdfauthor={Arif Rahman},
    pdfcreator={LaTeX with Arif Rahman},
    pdfsubject={Arif Rahman Resume},
    colorlinks=true,
...
\usepackage{academicons} % for using academic icons
